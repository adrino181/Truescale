...
export default function Header({ props }) {
  ...
  const { data } = props;
  return (
    <header className="bg-gradient-to-r from-violet-500 to-fuchsia-500 h-12 md:h-56 relative">
      <nav
      ...
      >
        ...
        <div className="flex lg:flex-1 justify-start">
          <a href="#">
            ...
            <img
              className="object-fit h-12 w-12 md:h-48 md:w-48 rounded-full absolute md:-bottom-24"
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">{data.handle}</span>
              <div className="h-23">
                <img
