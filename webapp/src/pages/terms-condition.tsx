const Terms = () => (
  <>
    ...
    <h2>{`1. Terms`}</h2>
    <p>
      {`By accessing this Website, accessible from truescale.in, you are agreeing
    ...
    <p>
      ...
      Truescale's Website for personal, non-commercial transitory viewing only.
    ...
    <ul>
      ...
      <li>
        {`attempt to reverse engineer any software contained on Truescale's
        Website;`}
      </li>
      <li>
    ...
    <p>
      {`This will let Truescale to terminate upon violations of any of these
    ...
    <h2>{`3. Disclaimer`}</h2>
    <p>
      {`All the materials on Truescale's Website are provided "as is". Truescale
      makes no warranties, may it be expressed or implied, therefore negates all
      other warranties. Furthermore, Truescale does not make any representations
    ...
    <h2>{`4. Limitations`}</h2>
    <p>
      {`Truescale or its suppliers will not be hold accountable for any damages
      that will arise with the use or inability to use the materials on
      Truescale's Website, even if Truescale or an authorize representative of
    ...
    <p>
      {`The materials appearing on Truescale's Website may include technical,
      typographical, or photographic errors. Truescale will not promise that any
      of the materials in this Website are accurate, complete, or current.
      Truescale may change the materials contained on its Website at any time
      without notice. Truescale does not make any commitment to update the
      materials.`}
    </p>
    <h2>{`6. Links`}</h2>
    <p>
      {`Truescale has not reviewed all of the sites linked to its Website and is
      not responsible for the contents of any such linked site. The presence of
      any link does not imply endorsement by Truescale of the site. The use of
      any linked website is at the user's own risk.`}
    </p>
    <h2>{`7. Site Terms of Use Modifications`}</h2>
    <p>
      {`Truescale may revise these Terms of Use for its Website at any time
    ...
    <p>
      {`Any claim related to Truescale's Website shall be governed by the laws of India
      in without regards to its conflict of law provisions.`}
    </p>
  </>
);
