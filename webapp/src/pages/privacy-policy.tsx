...
const Privacy = () => (
  <>
    ...
    <h1>{`Privacy Policy for Truescale`}</h1>

    <p>
      {`At Truescale, accessible from truescale.in, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types
      of information that is collected and recorded by Truescale and how we use
      it.`}
    </p>
    ...
    <p>
      {` Truescale follows a standard procedure of using log files. These files log
    ...
    <p>
      ...
      advertising partners of Truescale.`}
    </p>

    <p>
      {`Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Truescale, which are sent directly
    ...
    <p>
      {`Note that Truescale has no access to or control over these cookies that
    ...
    <p>
      {`Truescale's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      {`Truescale does not knowingly collect any Personal Identifiable Information
    ...
    <p>
      ...
      and/or collect in Truescale. This policy is not applicable to any
